---
title: "Billionaires should pay more in taxes, but the bracket is the wrong fight"
slug: "billionaires-bracket-wrong-fight"
date: "2026-02-07"
...
Why raising income taxes on billionaires misses the target
Raising income tax rates assumes billionaires "earn" their wealth like most people do. Many do not. Their wealth is mostly held in assets that grow in value: stock, equity, real estate, and other holdings. That growth is often unrealized, meaning it is not taxed until the asset is sold.
...
So without income, how do you tax the rich?
There are a few options, but the obvious one comes with a catch.
...
The real problem is how we tax work vs wealth
Work is taxed immediately and automatically. Wealth is taxed conditionally. That conditionality is what creates safe zones where economic power grows untaxed unless and until someone chooses to realize it.
...
Flip the default
What if we flipped the default? What if work was taxed more conditionally, with more earnings protected up front, while large concentrations of wealth faced an annual tax based on capacity, not just realized sales?
